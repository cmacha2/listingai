...
import { generateListingHTML } from "./templates/simple-generator-template";
...
Always respond with valid JSON only. The description field must contain HTML tags.`
      ...
      // Generate the HTML template using the external template module
      const htmlTemplate = generateListingHTML(analysis.title, analysis.description);
